    ...
    <section className="bg-white">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section className="relative flex h-32 items-center justify-center bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          ...
          <div className="relative text-center lg:p-12">
            ...
            <div className="mt-6 text-white text-center">
              <h2 className="text-2xl font-bold sm:text-3xl md:text-4xl drop-shadow-lg">
                Welcome to PrepMaster
              </h2>

              <p className="mt-4 leading-relaxed text-white/90 drop-shadow">
